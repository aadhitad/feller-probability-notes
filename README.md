...
**Focus:** Sample spaces, events, set operations, elementary probability, counting arguments, and selected worked exercises.

### Section 2: Conditional Probability & Independence (Chapter 5)

**Status:** In Progress

### Section 3: Binomial and Poisson Distributions (Chapter 6)

**Status:** Planned

### Section 4: Random Variables and Expectation (Chapter 9)
